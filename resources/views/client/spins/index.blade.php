                    ...
                    <div class="spin-card">
                        ...
                        <div class="spin-controls">
                            @auth
                                ...
                                @endif
                            @else
                                <button class="btn btn-spin" onclick="window.location.href='{{ route('login') }}'">
                                    🔐 Đăng nhập để quay
                                </button>
                                <div class="spin-info mt-3">
                            ...
                            @foreach($spins as $index => $spin)
                                <div class="prize-item">
                                    <div class="prize-icon-text">
                                        ...
                                        <span class="text">{{ $spin->name }}</span>
                                    </div>
                                    <span class="prize-rate">{{ $spin->probability }}%</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
