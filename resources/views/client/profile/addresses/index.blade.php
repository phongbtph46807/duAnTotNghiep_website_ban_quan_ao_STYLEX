...
@section('title', 'Địa chỉ giao hàng - ' . env('APP_NAME'))
            ...
            <div class="card profile-card">
                <div class="profile-card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('client.profile.addresses.create') }}" class="btn btn-primary-custom">
                                    ...
                                    <div class="address-card {{ $address->is_default ? 'default' : '' }}">
                                        <div class="address-header">
                                            <div>
                                                <span class="address-badge badge-default">
                                                    ...
                                                    {{ $address->is_default ? 'Mặc định' : 'Địa chỉ ' . $loop->iteration }}
                                                </span>
                                            ...
                                            <div class="address-actions">
                                                ...
                                                @endif
                                                <a href="{{ route('client.profile.addresses.edit', $address) }}" class="btn-action btn-edit" style="text-decoration: none;">
                                                    <i class="ri-edit-line me-1"></i> Sửa
                                                </a>
                                                <button type="button" class="btn-action btn-delete" data-address-id="{{ $address->id }}" onclick="deleteAddress(this.dataset.addressId)">
                                        ...
                                        <div style="line-height: 1.8;">
                                            ...
                                            <div style="color: #666; margin-bottom: 4px;">
                                                <i class="ri-phone-line me-1"></i>{{ $address->phone }}
                                            </div>
                                            @if($address->email)
                                                <div style="color: #666; margin-bottom: 4px;">
                                                    <i class="ri-mail-line me-1"></i>{{ $address->email }}
                                                </div>
                                            @endif
...
function setDefault(addressId) {
    ...
    const url = '{{ route("client.profile.addresses.set-default", ":id") }}'.replace(':id', addressId);
...
function deleteAddress(addressId) {
    ...
    const url = '{{ route("client.profile.addresses.destroy", ":id") }}'.replace(':id', addressId);
