            ...
            <div class="col-md-8 col-lg-9 p-b-80">
                <div class="p-r-45 p-r-0-lg">
                    ...
                    <div class="flex-w flex-t p-t-16">
                        <span class="size-216 stext-116 cl8 p-t-4">Thẻ:</span>
                    ...
                    <div class="p-t-50">
                        <h5 class="mtext-113 cl2 p-b-20">Bài viết liên quan</h5>
                        <div class="row">
                    ...
                    <!-- Comment form -->
                    <div class="p-t-40">
                        <h5 class="mtext-113 cl2 p-b-12">Để lại bình luận</h5>
                        ...
                        <form>
                            <div class="bor19 m-b-20">
                                <textarea class="stext-111 cl2 plh3 size-124 p-lr-18 p-tb-15" 
                                          name="cmt" placeholder="Bình luận..."></textarea>
                            </div>
                                ...
                                <li class="flex-w flex-t p-b-30">
                                    <a href="{{ route('client.products.show', $product->id) }}" 
                                       class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                        <img src="{{ $product->default_image_url ?? asset('client/images/no-image.jpg') }}" 
                                             alt="{{ $product->name }}">
                                    </a>
