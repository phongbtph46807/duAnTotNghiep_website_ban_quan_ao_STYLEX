            ...
            <div class="col-md-8 col-lg-9 p-b-80">
                <div class="p-r-45 p-r-0-lg">
                    ...
                    <div class="wrap-pic-w how-pos5-parent">
                        <img src="{{ Storage::url($blog->thumbnail) ?? asset('client/images/blog-default.jpg') }}" alt="{{ $blog->title }}">
                        ...
                        <div class="row">
                            @foreach($related_blogs as $related)
                                <div class="col-sm-6 col-lg-4 p-b-30">
                                    <a href="{{ route('client.blog.detail', $related->slug) }}" class="hov-img0 how-pos5-parent">
                                        <img src="{{ $related->thumbnail ?? asset('client/images/blog-default.jpg') }}" alt="{{ $related->title }}">
                                    </a>
                                    <div class="p-t-15">
                                        <a href="{{ route('client.blog.detail', $related->slug) }}" class="stext-112 cl2 hov-cl1 trans-04">
