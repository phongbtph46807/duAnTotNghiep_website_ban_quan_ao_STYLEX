            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">Chỉnh sửa: {{ $loyaltyTier->name }}</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.loyalty-tiers.update', $loyaltyTier) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" inputmode="decimal" name="min_spend_required" id="min_spend_required" class="form-control @error('min_spend_required') is-invalid @enderror" value="{{ old('min_spend_required', (float) $loyaltyTier->min_spend_required) }}" required>
