                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center mb-1">
                                    ...
                                    @elseif($userRole === 'staff')
                                     ...
                                     @elseif($userRole === 'warehouse_manager')
                                        <span class="badge bg-success">Warehouse Manager</span>
                                    @endif
                                </div>
                                <p class="text-muted mb-0">
                                    ...
                                    @elseif($userRole === 'warehouse_manager')
                                        Đây là tổng quan về kho hàng của bạn hôm nay.
                                    @endif
                                </p>
                            </div>
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                            {{ number_format($kpis['totalEarnings'], 0, ',', '.') }}đ
                                        </h4>
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ $kpis['totalOrders'] }}</h4>
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ $kpis['newCustomers'] }}</h4>
                    ...
                    <div class="col-xl-3 col-md-6">
                        ...
                        <div class="card card-animate">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ $kpis['totalProducts'] }}</h4>
                                        <a href="{{ route('admin.products.index') }}" class="text-decoration-underline">Quản lý sản phẩm</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="row g-0 text-center">
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1">{{ $kpis['pendingOrders'] }}</h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1">{{ $kpis['confirmedOrders'] }}</h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1">{{ $kpis['completedOrders'] }}</h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0 border-end-0">
                                            <h5 class="mb-1 text-danger">{{ $kpis['cancelledOrders'] }}</h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-sm bg-light rounded p-1 me-2">
                                                            @if($product->image)
                                                                <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->product_name }}"
                                                                    class="img-fluid d-block" style="width: 40px; height: 40px; object-fit: cover;" />
                                                            @else
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1">{{ $product->product_name }}</h5>
                                                            <span class="text-muted">{{ $product->color }} - {{ $product->size }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <h5 class="fs-14 my-1 fw-normal">{{ number_format($product->total_revenue, 0, ',', '.') }}đ</h5>
