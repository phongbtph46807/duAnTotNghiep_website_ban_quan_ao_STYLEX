...
@section('title', 'Thêm mới phần thưởng Spin')
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.spins.store') }}">
        @csrf
        <div class="card mb-3">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                               name="name" value="{{ old('name') }}" placeholder="Nhập tên phần thưởng" required>
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('probability') is-invalid @enderror"
                               name="probability" value="{{ old('probability', 10) }}" min="1" max="100" required>
