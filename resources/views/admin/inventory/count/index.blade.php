                    ...
                    <tbody>
                        @forelse ($requests as $request)
                            <tr>
                                ...
                                <td class="text-end">{{ $request->physical_qty ? number_format($request->physical_qty) : '-' }}</td>
                                <td class="text-end">
                                ...
                                <td class="text-end">
                                    ...
                                    @elseif ($request->status === 'COUNTED')
                                        <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#adjustmentModal{{ $request->id }}" title="Xác Nhận Điều Chỉnh">
                                            ...
                                            <form action="{{ route('admin.inventory.count.confirm-adjustment', $request->id) }}" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="damaged_qty" class="form-control" value="{{ $request->damaged_qty ?? 0 }}" min="0" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Ghi Chú</label>
                                                        <textarea name="notes" class="form-control" rows="2" placeholder="Ghi chú thêm...">{{ $request->notes }}</textarea>
                                                    </div>
                                                </div>
