                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="product-slug" name="slug"
                            value="{{ old('slug') }}" placeholder="Tự sinh theo tên sản phẩm">
                    </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <select id="attr-colors" class="form-select select2" multiple data-placeholder="Chọn màu sắc">
                            @foreach ($colors as $c)
                                <option value="{{ $c->id }}" data-name="{{ $c->name }}">{{ $c->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select id="attr-sizes" class="form-select select2" multiple data-placeholder="Chọn kích cỡ">
                            @foreach ($sizes as $s)
                                <option value="{{ $s->id }}" data-name="{{ $s->name }}">{{ $s->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select id="attr-textures" class="form-select select2" multiple
                            ...
                            @foreach ($textures as $t)
                                <option value="{{ $t->id }}" data-name="{{ $t->name }}">{{ $t->name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
