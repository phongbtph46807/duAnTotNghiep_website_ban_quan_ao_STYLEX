    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarSpins" data-bs-toggle="collapse" role="button"
                       aria-expanded="false" aria-controls="sidebarSpins">
                        <i class="ri-pages-line"></i> <span>Quản lí phần thưởng may mắn</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarSpins">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.spins.index')); ?>" class="nav-link">
                                    <i class="ri-list-check me-1"></i> Danh sách phần thưởng may mắn
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.spins.create')); ?>" class="nav-link">
                                    <i class="ri-add-circle-line me-1"></i> Thêm phần thưởng may mắn mới
                                </a>
                            </li>
                        </ul>
                    </div>
