        ...
        <div class="col-12 col-sm-6 col-md-3 mb-3">
            <div class="card stats-card total-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-text fw-bold"><?php echo e($banners_total ?? 0); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3 mb-3">
            <div class="card stats-card approved-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-text fw-bold text-success"><?php echo e($banners_active ?? 0); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3 mb-3">
            <div class="card stats-card pending-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-text fw-bold text-warning"><?php echo e($banners_inactive ?? 0); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3 mb-3">
            <div class="card stats-card rejected-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="card-text fw-bold text-danger"><?php echo e($banners_deleted ?? 0); ?></h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body" id="filterForm" style="display: none;">
                        <form action="<?php echo e(route('admin.banners.index')); ?>" method="GET">
                            <div class="row g-3">
                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="<?php echo e(route('admin.banners.create')); ?>" class="btn btn-success add-btn"><i
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap">
                                    ...
                                    <tbody id="sortableBanners" class="list form-check-all">
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr data-id="<?php echo e($banner->id); ?>">
                                                ...
                                                <td>
                                                    <div class="d-flex gap-1">
                                                        <div class="edit">
                                                            <form action="<?php echo e(route('admin.banners.edit', $banner->id)); ?>"
                                                                method="get">
                                                                <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="show">
                                                            <form action="<?php echo e(route('admin.banners.show', $banner->id)); ?>"
                                                                method="get">
                                                                <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="remove">
                                                            <form method="POST"
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    data-name="<?php echo e($banner->name); ?>">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LARAGON\laragon\www\DATN\duAnTotNghiep_website_ban_quan_ao_STYLEX\resources\views\admin\banners\index.blade.php ENDPATH**/ ?>