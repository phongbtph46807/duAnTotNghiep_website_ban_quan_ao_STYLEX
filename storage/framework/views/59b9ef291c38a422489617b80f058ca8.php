...
=======
									...
									var variant = item.variant || {};
<<<<<<<< HEAD:storage/framework/views/54f4e0c8993c6d3e0977dad5a3d7e80f.php
									var sizeName = variant.size ? (variant.size.name || '') : '';
									var colorName = variant.color ? (variant.color.name || '') : '';
									var textureName = variant.texture ? (variant.texture.name || '') : '';
========
...
>>>>>>>> origin:storage/framework/views/59b9ef291c38a422489617b80f058ca8.php
>>>>>>> origin
									var variantInfo = '';
...
<<<<<<< HEAD
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/duAnTotNghiep_website_ban_quan_ao_STYLEX/resources/views/client/partials/js/js.blade.php ENDPATH**/ ?>
=======
<<<<<<<< HEAD:storage/framework/views/54f4e0c8993c6d3e0977dad5a3d7e80f.php
