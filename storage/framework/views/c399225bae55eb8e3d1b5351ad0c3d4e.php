					...
					<!-- Menu desktop -->
					    ...
					    <ul class="main-menu">
					        ...
					        <li class="<?php echo e(request()->is('blog') ? 'active-menu' : ''); ?>">
					            <a href="<?php echo e(route('client.posts.index')); ?>">Blog</a>
					        </li>
...
<?php /**PATH C:\laragon\www\duAnTotNghiep_website_ban_quan_ao_STYLEX\resources\views/client/partials/sidebar.blade.php ENDPATH**/ ?>