...
<?php $__env->startSection('title', 'Sửa địa chỉ - ' . env('APP_NAME')); ?>
        ...
        <div class="col-lg-9 col-md-8">
            <div class="card profile-card">
                ...
                <div class="profile-card-body">
                    ...
                    <form action="<?php echo e(route('client.profile.addresses.update', $address)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="full_name" name="full_name" value="<?php echo e(old('full_name', $address->full_name)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="phone" name="phone" value="<?php echo e(old('phone', $address->phone)); ?>" 
                                       required style="border-radius: 8px; padding: 10px 15px; border: 1px solid #ddd;">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="email" name="email" value="<?php echo e(old('email', $address->email)); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        style="border-radius: 8px; padding: 10px 15px; border: 1px solid #ddd;">
                                    <option value="home" <?php echo e(old('address_type', $address->address_type) == 'home' ? 'selected' : ''); ?>>Nhà riêng</option>
                                    <option value="office" <?php echo e(old('address_type', $address->address_type) == 'office' ? 'selected' : ''); ?>>Văn phòng</option>
                                    <option value="other" <?php echo e(old('address_type', $address->address_type) == 'other' ? 'selected' : ''); ?>>Khác</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="city" name="city" value="<?php echo e(old('city', $address->city)); ?>" 
                                       required style="border-radius: 8px; padding: 10px 15px; border: 1px solid #ddd;">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="district" name="district" value="<?php echo e(old('district', $address->district)); ?>"
                                       style="border-radius: 8px; padding: 10px 15px; border: 1px solid #ddd;">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="ward" name="ward" value="<?php echo e(old('ward', $address->ward)); ?>"
                                       style="border-radius: 8px; padding: 10px 15px; border: 1px solid #ddd;">
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          style="border-radius: 8px; padding: 10px 15px; border: 1px solid #ddd;"><?php echo e(old('address', $address->address)); ?></textarea>
...
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LARAGON\laragon\www\DATN\duAnTotNghiep_website_ban_quan_ao_STYLEX\resources\views\client\profile\addresses\edit.blade.php ENDPATH**/ ?>