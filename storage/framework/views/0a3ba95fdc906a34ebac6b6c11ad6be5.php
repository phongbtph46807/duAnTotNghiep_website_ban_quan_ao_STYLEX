                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href="<?php echo e(route('admin.users.index')); ?>">Danh
                                    sách người
                                    dùng</a></li>
                            <li class="breadcrumb-item active"><a href="<?php echo e(route('admin.users.create')); ?>">Thêm mới
                                    người
                                    dùng</a></li>
                        </ol>
                    </div>
                    ...
                    <form action="<?php echo e(route('admin.users.store')); ?>" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control mb-2" name="name" id="fullname"
                                   placeholder="Nhập họ và tên của bạn" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="int" class="form-control mb-2" name="phone_number" id="inputEmail4"
                                   placeholder="Nhập số điện thoại" value="<?php echo e(old('phone_number')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="status" id="" class="form-select mb-2">
                                ...
                                <option <?php if(old('status') == 'active'): echo 'selected'; endif; ?> value="active">Active</option>
                                <option <?php if(old('status') == 'inactive'): echo 'selected'; endif; ?> value="inactive">Inactive</option>
                                <option <?php if(old('status') == 'blocked'): echo 'selected'; endif; ?> value="blocked">Blocked</option>
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-control-plaintext">
                                ...
                                <small class="text-warning">
                                    ...
                                    <a href="<?php echo e(route('admin.roles.index')); ?>" class="text-primary fw-bold">Phân quyền người dùng</a>
                                </small>
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <a class="btn btn-dark"
                               href="<?php echo e(route('admin.users.index')); ?>">Quay
                                lại</a>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LARAGON\laragon\www\DATN\duAnTotNghiep_website_ban_quan_ao_STYLEX\resources\views\admin\users\create.blade.php ENDPATH**/ ?>