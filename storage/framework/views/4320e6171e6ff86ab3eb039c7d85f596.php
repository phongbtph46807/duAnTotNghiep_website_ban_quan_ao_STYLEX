<?php $__env->startSection('title', 'Tạo Hạng thành viên mới'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.loyalty-tiers.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('min_spend_required')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('discount_rate')); ?>" required>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\LARAGON\laragon\www\DATN\duAnTotNghiep_website_ban_quan_ao_STYLEX\resources\views\admin\loyalty-tiers\create.blade.php ENDPATH**/ ?>