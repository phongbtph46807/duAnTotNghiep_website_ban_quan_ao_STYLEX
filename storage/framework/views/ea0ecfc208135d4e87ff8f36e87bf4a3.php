            ...
            <div class="row">
                <div class="col-md-8 col-lg-9 p-b-80">
                    <div class="p-r-45 p-r-0-lg">
                        ...
                        <div class="p-b-63">
                            <a href="<?php echo e(route('client.posts.show', $post->slug)); ?>" class="hov-img0 how-pos5-parent">
                            ...
                            <div class="p-t-32">
                                <h4 class="p-b-15">
                                    <a href="<?php echo e(route('client.posts.show', $post->slug)); ?>" class="ltext-108 cl2 hov-cl1 trans-04">
...
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\duAnTotNghiep_website_ban_quan_ao_STYLEX\resources\views\client\posts\index.blade.php ENDPATH**/ ?>