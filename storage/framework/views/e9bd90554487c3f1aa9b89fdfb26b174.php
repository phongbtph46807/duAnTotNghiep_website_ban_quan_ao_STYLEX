                        ...
                        <div class="col-md-12">
                            ...
                            <select name="is_admin" id="" class="form-select mb-2">
                                <option value="">Chọn vai trò</option>
                                    <option <?php echo e(old('is_admin') == 1 ? 'selected' : ''); ?> value="1">
                                        admin</option>
                                         <option <?php echo e(old('is_admin') == 0 ? 'selected' : ''); ?> value="0">
                                        user</option>
                            </select>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\duAnTotNghiep_website_ban_quan_ao_STYLEX\resources\views/admin/users/create.blade.php ENDPATH**/ ?>