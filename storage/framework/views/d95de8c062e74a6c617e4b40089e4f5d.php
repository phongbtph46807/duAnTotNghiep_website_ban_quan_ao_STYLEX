    ...
    <div class="table-responsive"><table class="table-history">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="<?php echo e(route('client.order.track',['code'=>$order->code??$order->id])); ?>" class="btn-primary-x">Xem chi tiết</a>
            <a href="<?php echo e(route('client.order.invoice',['code'=>$order->code??$order->id])); ?>" class="btn-primary-x" style="background:#eef3fb;color:#6777ef;border:1px solid #6777ef;margin-left:6px;">Hóa đơn PDF</a>
          </td>
...
<?php echo $__env->make('client.layout.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/duAnTotNghiep_website_ban_quan_ao_STYLEX/resources/views/client/order/index.blade.php ENDPATH**/ ?>