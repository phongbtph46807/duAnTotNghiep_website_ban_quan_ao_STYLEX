                            ...
                            <tbody>
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(route('client.order.track', ['code' => $order->code ?? $order->id])); ?>"
                                                ...
                                                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3 border p-2 rounded">
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-danger"
                                                            ...
                                                            data-bs-target="#reviewModal<?php echo e($item->id); ?>">
                                                            Đánh giá ngay
                                                        </button>
                                                    </div>
                                                    <?php else: ?>
                                                    ...
                                                    <div class="modal fade review-modal" id="reviewModal<?php echo e($item->id); ?>"
                                                        tabindex="-1" aria-labelledby="reviewModalLabel<?php echo e($item->id); ?>"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                            <form class="modal-content review-form" method="POST"
                                                                action="<?php echo e(route('client.order.sendReviewOrder')); ?>">
                                                                <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="modal-body">
                                                                        ...
                                                                        <div class="star-input">
                                                                            <?php for($i = 5; $i >= 1; $i--): ?>
                                                                                <input type="radio" name="rating"
                                                                                    id="rating<?php echo e($item->id); ?>_<?php echo e($i); ?>"
                                                                                    value="<?php echo e($i); ?>">
                                                                                <label
                                                                                    for="rating<?php echo e($item->id); ?>_<?php echo e($i); ?>">&#9733;</label>
                                                                            <?php endfor; ?>
                                                                        </div>
                                                                    </div>
                                                                                ...
                                                                                <div class="star-input">
                                                                                    <?php for($i = 5; $i >= 1; $i--): ?>
                                                                                        <input type="radio"
                                                                                            ...
                                                                                            id="fabric<?php echo e($item->id); ?>_<?php echo e($i); ?>"
                                                                                            value="<?php echo e($i); ?>">
                                                                                        <label
                                                                                            for="fabric<?php echo e($item->id); ?>_<?php echo e($i); ?>">&#9733;</label>
                                                                                    <?php endfor; ?>
                                                                                </div>
                                                                                <input type="hidden"
                                                                                ...
                                                                                <div class="star-input">
                                                                                    <?php for($i = 5; $i >= 1; $i--): ?>
                                                                                        <input type="radio"
                                                                                            ...
                                                                                            id="fit<?php echo e($item->id); ?>_<?php echo e($i); ?>"
                                                                                            value="<?php echo e($i); ?>">
                                                                                        <label
                                                                                            for="fit<?php echo e($item->id); ?>_<?php echo e($i); ?>">&#9733;</label>
                                                                                    <?php endfor; ?>
                                                                                </div>
                                                                                <input type="hidden"
                                                                                ...
                                                                                <div class="star-input">
                                                                                    <?php for($i = 5; $i >= 1; $i--): ?>
                                                                                        <input type="radio"
                                                                                            ...
                                                                                            id="color<?php echo e($item->id); ?>_<?php echo e($i); ?>"
                                                                                            value="<?php echo e($i); ?>">
                                                                                        <label
                                                                                            for="color<?php echo e($item->id); ?>_<?php echo e($i); ?>">&#9733;</label>
                                                                                    <?php endfor; ?>
                                                                                </div>
                                                                                <input type="hidden"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Chọn tiêu chí nổi
                                                                            bật</label><br>
                                                                        <?php $__currentLoopData = ['Chất liệu mềm mại', 'Form áo vừa vặn', 'Màu sắc tươi sáng']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input"
                                                                                    type="checkbox" name="tags[]"
                                                                                    value="<?php echo e($tag); ?>"
                                                                                    id="tag<?php echo e($item->id); ?>_<?php echo e(Str::slug($tag)); ?>">
                                                                                <label class="form-check-label"
                                                                                    for="tag<?php echo e($item->id); ?>_<?php echo e(Str::slug($tag)); ?>"><?php echo e($tag); ?></label>
                                                                            </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div id="previewContainer<?php echo e($item->id); ?>"
                                                                                class="d-flex flex-wrap justify-content-start gap-2 mb-2">
                                                                            </div>

                                                                            <label for="reviewImages<?php echo e($item->id); ?>"
                                                                                class="btn btn-outline-danger btn-sm rounded-pill">
                                                                                <i class="bi bi-camera"></i> Thêm ảnh
                                                                            </label>
                                                                            <input type="file" name="media[]"
                                                                                id="reviewImages<?php echo e($item->id); ?>"
