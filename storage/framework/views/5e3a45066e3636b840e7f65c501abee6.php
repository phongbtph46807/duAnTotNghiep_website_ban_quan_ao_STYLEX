            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarInventory">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item"><a href="<?php echo e(route('admin.inventory.dashboard')); ?>" class="nav-link"><i class="ri-dashboard-line me-1"></i> Tổng quan kho</a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="inventoryOperations">
                                    <ul class="nav nav-sm flex-column ms-3">
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.stock-in.index')); ?>" class="nav-link"><i class="ri-download-2-line me-1"></i> Nhập kho</a></li>
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.stock-out.index')); ?>" class="nav-link"><i class="ri-upload-2-line me-1"></i> Xuất kho</a></li>
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.transfer.index')); ?>" class="nav-link"><i class="ri-arrow-left-right-line me-1"></i> Chuyển kho</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="inventoryControl">
                                    <ul class="nav nav-sm flex-column ms-3">
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.count.index')); ?>" class="nav-link"><i class="ri-file-list-3-line me-1"></i> Kiểm kê</a></li>
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.defect.index')); ?>" class="nav-link"><i class="ri-error-warning-line me-1"></i> Hàng hỏng</a></li>
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.stock-out-invoice.index')); ?>" class="nav-link"><i class="ri-file-text-line me-1"></i> Hóa đơn thanh lý</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="inventoryReports">
                                    <ul class="nav nav-sm flex-column ms-3">
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.current-stock')); ?>" class="nav-link"><i class="ri-database-line me-1"></i> Tồn kho hiện tại</a></li>
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.reports')); ?>" class="nav-link"><i class="ri-file-chart-line me-1"></i> Báo cáo tồn kho</a></li>
                                        <li class="nav-item"><a href="<?php echo e(route('admin.inventory.logs')); ?>" class="nav-link"><i class="ri-history-line me-1"></i> Lịch sử giao dịch</a></li>
                                    </ul>
                                </div>
                            </li>

                            <li class="nav-item"><a href="<?php echo e(route('admin.inventory.warehouses.index')); ?>" class="nav-link"><i class="ri-home-4-line me-1"></i> Quản lý Kho hàng</a></li>
                            <li class="nav-item"><a href="<?php echo e(route('admin.inventory.settings')); ?>" class="nav-link"><i class="ri-settings-3-line me-1"></i> Cài đặt kho</a></li>

                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.notifications.index')); ?>" class="nav-link">
                                    <i class="ri-notification-badge-line me-1"></i> Thông báo
                                    <?php $unreadCount = \App\Models\Notification::where('user_id', auth()->id())->whereNull('read_at')->count(); ?>
                                    <?php if($unreadCount > 0): ?> <span class="badge bg-danger ms-2"><?php echo e($unreadCount); ?></span> <?php endif; ?>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <?php if(auth()->user()->role == 1): ?>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarSalaries">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item"><a href="<?php echo e(route('admin.salaries.index')); ?>" class="nav-link"><i class="ri-list-check me-1"></i> Danh sách lương</a></li>
                                <li class="nav-item"><a href="<?php echo e(route('admin.salaries.create')); ?>" class="nav-link"><i class="ri-add-circle-line me-1"></i> Thêm lương thủ công</a></li>
                                <li class="nav-item"><a href="<?php echo e(route('admin.salaries.generate-by-role')); ?>" class="nav-link"><i class="ri-automatic-line me-1"></i> Tạo lương tự động</a></li>
                                <li class="nav-item"><a href="<?php echo e(route('admin.role-salaries.index')); ?>" class="nav-link"><i class="ri-settings-3-line me-1"></i> Cài đặt lương role</a></li>
                                <li class="nav-item"><a href="<?php echo e(route('admin.salaries.history')); ?>" class="nav-link"><i class="ri-history-line me-1"></i> Lịch sử lương</a></li>
                            </ul>
                        </div>
                    </li>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\duAnTotNghiep_website_ban_quan_ao_STYLEX-main\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>