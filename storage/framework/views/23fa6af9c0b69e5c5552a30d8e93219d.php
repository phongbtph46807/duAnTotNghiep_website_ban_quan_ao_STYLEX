<?php $__env->startSection('title', 'Quản lý tài khoản có quyền'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mt-3">
                        <div class="flex-grow-1">
                            <h4 class="fs-22 fw-semibold ff-secondary mb-0"><?php echo e($totalUsers ?? 0); ?></h4>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mt-3">
                        <div class="flex-grow-1">
                            ...
                            <?php if($stat['role']->description): ?>
                                <p class="text-muted mb-0 mt-1">
                                    <small><?php echo e(Str::limit($stat['role']->description, 30)); ?></small>
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\duAnTotNghiep_website_ban_quan_ao_STYLEX\resources\views\admin\roles\index.blade.php ENDPATH**/ ?>