...
<div class="container-fluid">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?php echo e(route('admin.inventory.stock-in.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="batch_number" id="batch_number" class="form-control <?php $__errorArgs = ['batch_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="cost_price" id="cost_price" class="form-control <?php $__errorArgs = ['cost_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('cost_price')); ?>" min="0" step="0.01">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="received_date" class="form-control <?php $__errorArgs = ['received_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('received_date', date('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="supplier_name" class="form-control <?php $__errorArgs = ['supplier_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('supplier_name')); ?>" placeholder="Ví dụ: Công ty TNHH ABC">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="supplier_contact" class="form-control <?php $__errorArgs = ['supplier_contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('supplier_contact')); ?>" placeholder="SĐT hoặc Email">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="invoice_number" class="form-control <?php $__errorArgs = ['invoice_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('invoice_number')); ?>" placeholder="Ví dụ: INV-2024-001">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\duAnTotNghiep_website_ban_quan_ao_STYLEX-main\resources\views/admin/inventory/stock-in/create.blade.php ENDPATH**/ ?>