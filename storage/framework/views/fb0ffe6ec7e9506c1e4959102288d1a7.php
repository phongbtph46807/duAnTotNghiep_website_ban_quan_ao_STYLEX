...
<div class="container-fluid">
    <div class="row mb-3">
        ...
        <div class="col-md-6 text-end">
            <a href="<?php echo e(route('admin.inventory.transfer.index')); ?>" class="btn btn-secondary btn-sm">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?php echo e(route('admin.inventory.transfer.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Kho Nguồn <span class="text-danger">*</span></label>
                        <select name="from_warehouse_id" id="from_warehouse_id" class="form-select <?php $__errorArgs = ['from_warehouse_id'];
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($warehouse->id); ?>" <?php echo e(old('from_warehouse_id') == $warehouse->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="to_warehouse_id" class="form-select <?php $__errorArgs = ['to_warehouse_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($warehouse->id); ?>" <?php echo e(old('to_warehouse_id') == $warehouse->id ? 'selected' : ''); ?>>
                                    <?php echo e($warehouse->name); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.inventory.transfer.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\duAnTotNghiep_website_ban_quan_ao_STYLEX-main\resources\views/admin/inventory/transfer/create.blade.php ENDPATH**/ ?>