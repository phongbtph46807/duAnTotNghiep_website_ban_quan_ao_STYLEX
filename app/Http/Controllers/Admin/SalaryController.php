    ...
    public function approve($id)
    {
        try {
            ...
            if (!$salary->canBeApproved()) {
                return back()->with('error', 'Chỉ có thể phê duyệt lương ở trạng thái PENDING');
            }
            ...
            return redirect()->route('admin.salaries.index')
                ->with('success', "Phê duyệt lương cho {$salary->user->name} thành công");
    ...
    public function reject(Request $request, $id)
    {
        ...
        try {
            ...
            if (!$salary->canBeRejected()) {
                return back()->with('error', 'Chỉ có thể từ chối lương ở trạng thái PENDING');
            }
            ...
            return redirect()->route('admin.salaries.index')
                ->with('success', "Từ chối lương cho {$salary->user->name} thành công");
