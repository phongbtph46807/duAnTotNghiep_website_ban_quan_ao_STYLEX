...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::create('spin_prizes', function (Blueprint $table) {
            ...
            $table->string('value_reference', 100)->nullable()->comment('FK voucher_id hoặc giá trị điểm'); 
            $table->decimal('probability', 5, 4)->comment('Xác suất quay trúng (0.0000 - 1.0000)');
            $table->timestamps();
        });
        // 4. Lịch sử lượt quay của người dùng (Tạm thời không có FK)
        ...
        // 5. Đánh giá sản phẩm (Tạm thời không có FK)
